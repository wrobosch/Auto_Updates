...
void loop() {
  if (IS_OK(lidar.waitPoint())) {
    ...
    if (lidar.getCurrentPoint().startBit) 
    {
      ...
      if(speedDistance < 170 || minDistance < 80)
      {
      ...
      else if(speedDistance < 280 )
      {
        mSpeed = 60;
      }
      else if(speedDistance < 320 || minDistance < 100)
      {
        mSpeed = 80;
      }
      ...
      angleAtBackDist = 0;
       ...
       if (-25 < angle && angle < 25 &&  distance < speedDistance && distance > 50) 
       {
       ...
       if ((-50 < angle && angle < -25 || 25 < angle && angle < 50) && distance < 600 && distance > 50)
       {
